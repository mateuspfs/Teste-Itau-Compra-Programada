...
namespace Itau.CompraProgramada.Infrastructure.Imports
{
    public class CotacaoImport(
        ICotacaoRepository cotacaoRepository, 
        ILogRepository logRepository,
        ILogger<CotacaoImport> logger) : ICotacaoImport
    {
        ...
        {
            var log = new Log(nivel, mensagem, excecao, nameof(CotacaoImport));
