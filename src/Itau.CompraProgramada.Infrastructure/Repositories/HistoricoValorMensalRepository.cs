...
{
    public class HistoricoValorMensalRepository(ApplicationDbContext context) 
        : GenericRepository<HistoricoValorMensal>(context), IHistoricoValorMensalRepository
    {
    }
}
